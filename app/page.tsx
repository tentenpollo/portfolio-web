  ...
  return (
    <>
      ...
      <main className="relative z-10 w-full max-w-full overflow-x-clip flex flex-col">
        <section
          className="min-h-screen flex flex-col justify-center items-center ink-gradient relative px-6"
          id="hero"
        >
          ...
          <ScrollReveal>
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-start">
              <div className="md:col-span-4">
                <p className="text-xs font-semibold tracking-[0.2em] uppercase text-outline mb-6">
                  About Me
                </p>
        ...
        >
          <ScrollReveal>
            <p className="text-xs font-semibold tracking-[0.2em] uppercase text-outline mb-12">
              Get in Touch
            </p>
